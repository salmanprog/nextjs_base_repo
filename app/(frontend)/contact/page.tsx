                ...
                <div className="container">
                    <div className="grid grid-cols-1 md:grid-cols-2 justify-between items-center gap-10">
                        <div className="flex flex-col gap-5 contact-con order-2 md:order-1">
                            ...
                            <h3 className="hd-md flex items-center gap-2"><span><Icons.phone className="text-[20px] contact-icon" /></span> <Link className="underline hover:text-[var(--secondary-theme-light)]" href="tel:4436993000">443-699-3000</Link></h3>
