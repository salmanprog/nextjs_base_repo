...
export default function EventCategoryFaqList() {
  ...
  const handleDelete = async () => {
    ...
    await fetch(`/api/admin/events/category/faq/${deleteSlug}`, {
      method: "DELETE",
    });
          ...
          <TableBody className="divide-y divide-gray-100 dark:divide-gray-800">
            {faqs.map((faq) => (
              <TableRow key={faq.id} className="">
                ...
                <ActionMenu
                    editUrl={`/admin/event-category-faq/edit/${faq.slug}`}
                    onDelete={() => {
                      setDeleteSlug(faq.slug);
